...
export const marina: Record<Lang, MarinaRow[]> = {
  pt: [
    { label: ‘💼 Profissão’, value: ‘Gerente de Projetos’ },
    { label: ‘👨‍👩‍👧‍👦 Família’, value: ‘Mãe de 2 filhos · Casada’ },
    { label: ‘💰 Renda’, value: ‘R$8K/mês · Estável’ },
    { label: ‘🏙️ Localização’, value: ‘São Paulo’ },
    { label: ‘⏰ Principal dor’, value: ‘Tempo & decisão rápida’ },
    { label: ‘🎯 Solução’, value: ‘Automação de tarefas’ },
  ],
  en: [
    { label: ‘💼 Profession’, value: ‘Project Manager’ },
    { label: ‘👨‍👩‍👧‍👦 Family’, value: ‘Mother of 2 · Married’ },
    { label: ‘💰 Income’, value: ‘R$8K/month · Stable’ },
    { label: ‘🏙️ Location’, value: ‘São Paulo’ },
    { label: ‘⏰ Main pain’, value: ‘Time & quick decisions’ },
    { label: ‘🎯 Solution’, value: ‘Task automation’ },
  ],
};
