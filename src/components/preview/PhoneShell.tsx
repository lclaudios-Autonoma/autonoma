...
export function TabBar({ active }: { active: 'home' | 'chat' | 'agents' | 'profile' }) {
  ...
  const tabs = [
    ...
    { id: 'agents', label: lang === 'pt' ? 'Agentes' : 'Agents', icon: <><rect x="4" y="4" width="16" height="16" rx="2"/><rect x="9" y="9" width="6" height="6"/><line x1="9" y1="1" x2="9" y2="4"/><line x1="15" y1="1" x2="15" y2="4"/><line x1="9" y1="20" x2="9" y2="23"/><line x1="15" y1="20" x2="15" y2="23"/><line x1="20" y1="9" x2="23" y2="9"/><line x1="20" y1="14" x2="23" y2="14"/><line x1="1" y1="9" x2="4" y2="9"/><line x1="1" y1="14" x2="4" y2="14"/></> },
    { id: 'profile', label: lang === 'pt' ? 'Perfil' : 'Profile', icon: <><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></> },
  ] as const;
...
export function ActivePill({ label, gold = false }: { label?: string; gold?: boolean }) {
  const { lang } = useLang();
  if (label === undefined) label = lang === 'pt' ? 'ativo' : 'active';
  return (
