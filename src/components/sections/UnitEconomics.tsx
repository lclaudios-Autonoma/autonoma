...
const T: Record<Lang, {
  ...
  pt: {
    ...
    titleHi2: '1,8 meses',
    lead: 'Cenário Conservador: ticket R$49,90 (assinatura + agentes) · API Sonnet 4.6 R$5,83/mês · margem unitária R$44,07 · LTV R$551 · CAC R$80. Escala para LTV/CAC 10,3× (Base) e 13,9× (Otimista) conforme conversão e retenção evoluem.',
  ...
  en: {
    ...
    titleHi2: '1.8 months',
    lead: 'Conservative scenario: ticket R$49.90 (subscription + agents) · Sonnet 4.6 API R$5.83/mo · unit margin R$44.07 · LTV R$551 · CAC R$80. Scales to LTV/CAC 10.3× (Base) and 13.9× (Optimistic) as conversion and retention evolve.',
