...
const T: Record<Lang, {
  ...
  pt: {
    ...
    titlePre: 'LTV/CAC ',
    titleHi1: '6,2×',
    titleMid: ' (mensal) · payback em ',
    titleHi2: '2,0 meses',
    lead: 'Plano Noma: ticket R$39,90 · API com Prompt Caching R$6,00/mês · margem unitária R$29,91 (75%) · LTV R$374 · CAC R$60. Escala para LTV/CAC 9,6× (anual) e 12,1× (com agente) conforme mix evolui.',
    breakdownLabel: 'Breakdown · por assinante / mês · plano Noma',
    funnelLabel: 'Funil de conversão · 1.500 trials → 225 pagantes',
    ltvLabel: 'Cálculo de LTV · 4 perfis: mensal → anual → mensal+agente → anual+agente',
  },
  en: {
    eyebrow: '08 · Unit Economics',
    titlePre: 'LTV/CAC ',
    titleHi1: '6.2×',
    titleMid: ' (monthly) · payback in ',
    titleHi2: '2.0 months',
    lead: 'Noma plan: ticket R$39.90 · API with Prompt Caching R$6.00/mo · unit margin R$29.91 (75%) · LTV R$374 · CAC R$60. Scales to LTV/CAC 9.6× (annual) and 12.1× (with agent) as mix evolves.',
    breakdownLabel: 'Breakdown · per subscriber / month · Noma plan',
    funnelLabel: 'Conversion funnel · 1,500 trials → 225 paying',
    ltvLabel: 'LTV calculation · 4 profiles: monthly → annual → monthly+agent → annual+agent',
  },
};
