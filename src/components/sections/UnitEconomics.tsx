...
const T: Record<Lang, {
  ...
  pt: {
    ...
    titleHi2: '~2,5 meses',
    lead: 'Cenário Conservador: ticket R$44,90 (assinatura Essencial) · API Haiku/Sonnet R$15,00/mês · margem unitária R$25,41 · LTV R$431 · CAC R$60. Escala para LTV/CAC 7,3× (Base) e 10,2× (Otimista) conforme conversão e retenção evoluem.',
  ...
  en: {
    ...
    titleHi2: '~2.5 months',
    lead: 'Conservative scenario: ticket R$44.90 (Essencial subscription) · Haiku/Sonnet API R$15.00/mo · unit margin R$25.41 · LTV R$431 · CAC R$60. Scales to LTV/CAC 7.3× (Base) and 10.2× (Optimistic) as conversion and retention evolve.',
